...
-   Hajra Ojha (Coordinator)

-   Anishka Fernandopulle

### Communication Plan

-   We will communicate using iMessage, leaving comments on Google Drive (and restating on iMessage) for the written portions, and using GitHub (and restating on iMessage) for the coding portions.

-   We will respond to messages within 6 hours during the day, saying we cannot reply/ do the requested work if we are busy.

-   Hajra Ojha will be responsible for organizing our meetings and keeping minutes

-   WhatsApp will be used in case our other method stops working

### Meeting Schedule

-   The set time is once a week, in person, on Monday after class but we will change the day or increase the frequency if needed.

-   Meeting minutes will be recorded by Hajra Ojha

-   On days we cannot meet in person, we will use Zoom.

### Responsibilities

-   Sidharth Mirchandani is most familiar with coding, so they will have the responsibility of managing the data for the project using GitHub

-   Radhika Iyer and Anishka Fernandopulle will do the literature review

-   All of the students will develop and estimate the model together

-   Hajra Ojha will develop the background material and create visualizations

-   Sidharth and Anishka will write and create tables of results

-   Anishka will be the main analyst, while Radhika will be in charge of drafting the paper

-   We will divide up sections of the paper, which Sidharth will edit and combine

-   Hajra will be the coordinator

### Conflict Resolution

-   If we have an issue, we will discuss it amongst ourselves first and try to come to an agreement or find a solution.

-   If we cannot decide amongst ourselves, we will reach out to Prof. Graves for guidance.

-   We will keep our action logs up to date, documenting any issues.
